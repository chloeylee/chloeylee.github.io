...
// about me accordian functionality
document.querySelectorAll('.aboutInner').forEach((aboutInner) => {
  aboutInner.addEventListener('click', () => {
    const jobDesc = aboutInner.nextElementSibling;
